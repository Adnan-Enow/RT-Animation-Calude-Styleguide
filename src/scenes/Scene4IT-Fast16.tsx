 ...
 * ──────────────────────────────────────────────────────────────────────── */
/* Scaled by 480/660 (≈0.727) from Scene4IT-Fast.tsx for the 16s variant.
 * Slide distances (px) are NOT scaled — only frame-based timings. */
export const T_SCENE4_FAST = {
  // Chrome — Scene 4's plain nav rects fade back in.
  headerFadeIn: { start: 356, end: 378 },

  // Frame 1 — ticket card.  Slides up from below as it fades in.
  f1FadeIn: { start: 371, end: 389 },
  f1FadeOut: { start: 396, end: 411 },
  f1SlideFromY: 22,

  // Frame 3 — pixel "IT" logo + 2 chat bubbles.
  f3FadeIn: { start: 400, end: 429 },
  f3FadeOut: { start: 440, end: 455 },

  // Frame 4 — resolved ticket with green badge.  Starts exactly when F3
  // finishes fading out so there's no visual overlap between the frames.
  f4FadeIn: { start: 455, end: 476 },
  f4SlideFromY: 22,

 ...
 * ──────────────────────────────────────────────────────────────────────── */
/* Scaled by 480/660 (≈0.727) from Scene3Staffing-Fast.tsx for the 16s variant. */
export const T_SCENE3_FAST = {
  // Chrome — nav rects + search bar fade in as the macOS dots fade out.
  headerFadeIn: { start: 236, end: 258 },

  // Search-bar text — fades in alongside the footer typing the same words.
  searchTextFadeIn: { start: 251, end: 277 },

  // 4 cards cascade in from the top of the list.
  cardsCascadeStart: 247,
  cardsCascadeStagger: 6,
  cardsCascadeDuration: 13,
  // 4 cards × 6 + 13 → last card ends at 247 + 3*6 + 13 = 278

  // Per-card zoom pulse — each card briefly scales up after appearance.
  //   Card 0: pulse 260–267
  //   Card 1: pulse 266–273
  //   Card 2: pulse 272–279
  //   Card 3: pulse 278–285
  cardPulseDuration: 7,
  cardPulsePeakScale: 1.06,

  // Selection cue (checkmark only) on Card 3 — waits until all pulses end.
  selectionCue: { start: 286, end: 295 },

  // Cards fade out → success state takes over.
  cardsFadeOut: { start: 298, end: 311 },

  // Frame 3 — success state.
  f3CircleFadeIn: { start: 302, end: 324 },
  f3CheckmarkFadeIn: { start: 320, end: 338 },
  f3LabelsFadeIn: { start: 335, end: 353 },

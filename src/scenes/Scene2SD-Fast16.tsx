 ...
 * ──────────────────────────────────────────────────────────────────────── */
/* Scaled by 480/660 (≈0.727) from Scene2SD-Fast.tsx for the 16s variant. */
export const T_SCENE2_FAST = {
  // Chrome — macOS window controls fade in during the bridge.
  headerFadeIn: { start: 102, end: 124 },

  // Frame 2 — code editor structure fades in, then 12 code lines type in.
  f2StructureFadeIn: { start: 120, end: 142 },
  f2CodeLinesStart: 138,
  f2CodeLinesStagger: 2,
  f2CodeLineDuration: 5,
  // 12 lines × 2 stagger + 5 dur → last line ends at 138 + 11*2 + 5 = 165
  f2FadeOut: { start: 175, end: 193 },

  // Frame 3 — kanban dashboard. Single fade-in window driving 3 sub-phases.
  f3FadeIn: { start: 182, end: 215 },
